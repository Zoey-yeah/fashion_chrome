...
echo ✓ Extension built! Files are in the 'dist' folder
...
if exist ".env" (
    ...
    if /i "%HAS_KEY%"=="y" (
        ...
        echo.
        echo ⚠ Skipping API setup. The extension will work in preview mode.
...
echo      → Or run: cd backend ^&^& venv\Scripts\activate ^&^& uvicorn app.main:app --reload --port 8000
echo.
echo   3. Try it out:
